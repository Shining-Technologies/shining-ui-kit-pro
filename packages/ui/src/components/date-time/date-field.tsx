...
import { fromIso, type IsoDate } from './date-utils'
      ...
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="sui-date-field__popover" align="start">
          <Calendar
            ...
            max={max}
            label={trigger.text}
            // Named like the trigger: by the field's visible label when there is
            // one and no explicit `label`, rather than by the generic "Date".
