...
describe('clickable stats card', () => {
  it('puts no block elements inside its button, loading or not', () => {
    ...
    // The button is stretched over the card rather than wrapped around it, so
    // the placeholder sits in the card beside it.
    expect(button.parentElement!.querySelector('.sui-skeleton')).toBeInTheDocument()
  })
})
