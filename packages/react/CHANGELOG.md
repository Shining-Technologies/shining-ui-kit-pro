...
- e62526e: Add a dashboard sidebar.
...
- e62526e: Add summary and process components to cards & feedback.
...
- e62526e: Usability and publish-readiness audit: every component checked for real-world use, with fixes and regression tests.
