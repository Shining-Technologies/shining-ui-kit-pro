...
/**
 * Variant names follow shadcn/ui, which is the vocabulary the design this kit
 * implements is written in. `solid`, `danger` and `md` are kept as aliases so
 * call sites written against the earlier table-only API keep working.
 */
export const buttonVariants = cva('sui-btn sui-focusable', {
  variants: {
    variant: {
      ...
      solid: 'sui-btn--primary',
      /** @deprecated Use `destructive`. */
      danger: 'sui-btn--destructive',
    },
    size: {
